...
Okay, now lets build a plan for the "Product Demo" and "Gartner Briefing" (PDF)
- Review the following critical capability definitions from the welcome packet
...
- Considering the questions in the "Product or Service" section, what should we focus on in our 5 minute demos? 