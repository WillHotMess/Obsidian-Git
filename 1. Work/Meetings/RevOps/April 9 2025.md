...
## Sales Accountability Issues

The discussion revealed serious sales accountability problems:

1. **Follow-up Failures**: Nick highlighted that 60 accounts with open opportunities had no activity in the past two weeks. Specific examples included a Frontier Airlines opportunity with no follow-up for 45 days despite clear next steps.
2. **Basic Sales Execution Problems**: The team identified that sales reps aren't following fundamental sales practices:
    - Not scheduling next steps during calls
    - Taking 5+ days to follow up after demos
    - Not keeping Salesforce updated with notes and activities
    - Not dispositioning opportunities properly
3. **Ownership Gap**: Reps frequently blame poor fit rather than taking ownership of pipeline management. However, this contradicts the pre-pipeline qualification process, where Caleb and the AE agree an opportunity is a good fit before it enters the pipeline.
4. **Proposed Solutions**:
    - Craig offered to conduct one-on-one pipeline reviews with reps
    - The team discussed creating clear, non-negotiable sales activity expectations
    - Craig suggested an executive sponsorship model where XCOM members would work directly with individual reps
    - Brendan argued the accountability should remain with Steve (Sales leader)
--- 
